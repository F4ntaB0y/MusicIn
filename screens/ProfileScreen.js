...
// Nama File: screens/ProfileScreen.js
// Penjelasan singkat:
// Mengelola profil pengguna sederhana: nama dan foto.
// Data disimpan di AsyncStorage dengan key STORAGE_KEY_NAME dan STORAGE_KEY_IMAGE.
// Fitur: pilih gambar dari galeri, edit nama via modal.
// Istilah: AsyncStorage = penyimpanan key-value di device.
...
export default function ProfileScreen() {
  ...
  // Saat mount, muat data dari AsyncStorage
  useEffect(() => {
    loadProfileData();
  }, []);
  ...
  // handlePickImage: meminta izin akses galeri lalu ambil gambar.
  // ImagePicker.launchImageLibraryAsync mengembalikan objek result dengan assets.
  const handlePickImage = async () => {
    ...
    if (!result.canceled) {
      ...
      await AsyncStorage.setItem(STORAGE_KEY_IMAGE, newImageUri); // simpan path gambar
    }
  };
  ...
  // handleSaveName: validasi nama tidak kosong lalu simpan ke AsyncStorage
